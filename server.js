...
const CT_PRIVATE_CAMPUSES = [
  ...
  { campus: "Sacred Heart University", type: "generic", url: "https://www.sacredheart.edu/offices--departments-directory/human-resources/job-postings/" },
  ...
  { campus: "Holy Apostles College and Seminary", type: "generic", url: "https://holyapostles.edu/employment/" },
];
...
const MA_PRIVATE_CAMPUSES = [
  ...
  { campus: "Lasell University", type: "generic", url: "https://www.lasell.edu/discover-lasell/employment.html" },
  { campus: "Massachusetts Bay Community College", type: "generic", url: "https://www.massbay.edu/careers" },
  { campus: "MCPHS University", type: "generic", url: "https://www.mcphs.edu/human-resources/careers" },
  { campus: "Regis College", type: "generic", url: "https://www.regiscollege.edu/faculty-employment" },
  { campus: "Saint John's Seminary", type: "generic", url: "https://www.sjs.edu/employment" },
  { campus: "Stonehill College", type: "generic", url: "https://www.stonehill.edu/offices-and-services/human-resources/careers-at-stonehill/" },
  { campus: "University of Massachusetts-Central Office", type: "generic", url: "https://www.massachusetts.edu/careers" },
  { campus: "Urban College of Boston", type: "generic", url: "https://urbancollege.edu/faculty-employment" },
  { campus: "Wentworth Institute of Technology", type: "generic", url: "https://wit.edu/co-ops-careers" },
  { campus: "Massachusetts Maritime Academy", type: "generic", url: "https://www.maritime.edu/human-resources/employment-opportunities" },
  { campus: "Montserrat College of Art", type: "generic", url: "https://www.montserrat.edu/careers/" },
  { campus: "Quincy College", type: "generic", url: "https://quincycollege.edu/about/human-resources/" },
...
const CA_PRIVATE_CAMPUSES = [
  ...
  { campus: "Imperial Valley College", type: "generic", url: "https://www.imperial.edu/faculty-and-staff/human-resources/jobs/index.html" },
  { campus: "Laney College", type: "generic", url: "https://laney.edu/employment" },
  { campus: "Latin American Bible Institute", type: "generic", url: "https://www.labi.edu/academics/faculty-jobs" },
  { campus: "Los Rios Community College District Office", type: "generic", url: "https://losrios.edu/community/jobs-at-los-rios" },
  { campus: "Menlo College", type: "generic", url: "https://www.menlo.edu/employment-opportunities/" },
  { campus: "MiraCosta College", type: "generic", url: "https://www.miracosta.edu/faculty-employment" },
  { campus: "Rancho Santiago Community College District Office", type: "generic", url: "https://rsccd.edu/faculty-employment" },
  { campus: "Reach University", type: "generic", url: "https://reach.edu/careers" },
  { campus: "Santa Ana College", type: "generic", url: "https://www.sac.edu/faculty-employment" },
  { campus: "Santa Monica College", type: "generic", url: "https://admin.smc.edu/administration/human-resources/employment/index.php" },
  { campus: "Soka University of America", type: "generic", url: "https://www.soka.edu/jobs" },
  { campus: "Southwestern College", type: "generic", url: "https://www.schooljobs.com/careers/southwesterncollege" },
  { campus: "Teachers College of San Joaquin", type: "generic", url: "https://teacherscollegesj.edu/careers/" },
  { campus: "The Master's University and Seminary", type: "generic", url: "https://www.masters.edu/faculty-staff/careers-at-tmus/" },
  { campus: "Touro University Worldwide", type: "generic", url: "https://www.tuw.edu/about/careers/" },
  { campus: "University of California College of the Law-San Francisco", type: "generic", url: "https://www.uclawsf.edu/offices-and-services/provost-academic-dean/faculty-employment-opportunities/" },
  { campus: "University of San Diego", type: "generic", url: "https://www.sandiego.edu/careers/faculty/" },
  { campus: "West Valley Mission Community College District Office", type: "generic", url: "https://www.wvm.edu/careers/" },
  { campus: "Woodland Community College", type: "generic", url: "https://wcc.yccd.edu/about/employment/" },
  { campus: "Yo San University of Traditional Chinese Medicine", type: "generic", url: "https://yosan.edu/careers-at-ysu/" },
  ...
  { campus: "Marshall B Ketchum University", type: "generic", url: "https://www.ketchum.edu/about-us/employment" },
  { campus: "Minerva University", type: "generic", url: "https://www.minerva.edu/careers/" },
  { campus: "Palo Alto University", type: "generic", url: "https://paloaltou.edu/careers" },
  { campus: "Saint Mary's College of California", type: "generic", url: "https://www.stmarys-ca.edu/offices-services/human-resources/jobs-saint-marys-college" },
  { campus: "University of Massachusetts Global", type: "generic", url: "https://www.umassglobal.edu/careers" },
  { campus: "Whittier College", type: "generic", url: "https://www.whittier.edu/humanresources/employment" },
...
const PA_PRIVATE_CAMPUSES = [
  ...
  { campus: "La Roche University", type: "generic", url: "https://laroche.edu/employment/" },
  { campus: "Lackawanna College", type: "generic", url: "https://www.lackawanna.edu/about/employment/" },
  { campus: "Lehigh Carbon Community College", type: "generic", url: "https://www.lccc.edu/about/employment/" },
  { campus: "Lincoln University (PA)", type: "generic", url: "https://www.lincoln.edu/careers/" },
  { campus: "Lycoming College", type: "generic", url: "https://www.lycoming.edu/human-resources/employment-opportunities.aspx" },
  ...
  { campus: "Philadelphia College of Osteopathic Medicine", type: "generic", url: "https://www.pcom.edu/about/departments/human-resources/career-opportunities/" },
  { campus: "Pittsburgh Institute of Aeronautics", type: "generic", url: "https://pia.edu/employment/" },
  { campus: "Pittsburgh Theological Seminary", type: "generic", url: "https://www.pts.edu/employment-opportunities" },
  { campus: "Rosedale Technical College", type: "generic", url: "https://rosedaletech.edu/careers/" },
  { campus: "Rosemont College", type: "generic", url: "https://rosemont.edu/college/office/human-resources-careers/" },
  { campus: "Saint Charles Borromeo Seminary-Overbrook", type: "generic", url: "https://www.scs.edu/about/employment-opportunities/" },
  { campus: "Saint Vincent College", type: "generic", url: "https://www.stvincent.edu/resources/careers.html" },
  { campus: "Susquehanna University", type: "generic", url: "https://www.schooljobs.com/careers/susqu" },
  { campus: "Thiel College", type: "generic", url: "https://www.thiel.edu/academics/faculty-jobs" },
  { campus: "Ursinus College", type: "generic", url: "https://www.ursinus.edu/offices/human-resources/employment-opportunities/" },
  { campus: "Waynesburg University", type: "generic", url: "https://www.waynesburg.edu/careers" },
  { campus: "Williamson College of the Trades", type: "generic", url: "https://williamson.edu/employment-opportunities/" },
  { campus: "Grove City College", type: "generic", url: "https://www.gcc.edu/Utility/Portals/Employment" },
  ...
  { campus: "King's College", type: "generic", url: "https://www.kings.edu/human-resources/careers.html" },
  { campus: "Moore College of Art and Design", type: "generic", url: "https://moore.edu/about/careers-at-moore/" },
  { campus: "Neumann University", type: "generic", url: "https://www.neumann.edu/about/humanresources/employment" },
  { campus: "Saint Francis University", type: "generic", url: "https://www.francis.edu/about-us/employment" },
  { campus: "Temple University", type: "generic", url: "https://temple.taleo.net/careersection/tu_ex_faculty/jobsearch.ftl?lang=en" },
  { campus: "University of Scranton", type: "generic", url: "https://www.scranton.edu/hr/employment/employmentopportunities.shtml" },
  { campus: "Westmoreland County Community College", type: "generic", url: "https://westmoreland.edu/about/employment/index.html" },
  { campus: "Wilson College", type: "generic", url: "https://www.wilson.edu/employment-opportunities" },
  { campus: "Lake Erie College of Osteopathic Medicine", type: "generic", url: "https://lecom.edu/jobs/" },
  { campus: "Mercyhurst University", type: "generic", url: "https://www.mercyhurst.edu/human-resources/jobs" },
  { campus: "Pennsylvania College of Art and Design", type: "generic", url: "https://pcad.edu/employment/" },
...
const NC_CAMPUSES = [
  ...
  { campus: "Richmond Community College", type: "generic", url: "https://richmondcc.edu/contact-us/employment" },
  { campus: "South Piedmont Community College", type: "generic", url: "https://spcc.edu/about/employment/" },
  { campus: "Surry Community College", type: "generic", url: "https://jobs.surry.edu/" },
  { campus: "University of Mount Olive", type: "generic", url: "https://umo.edu/employment/" },
  { campus: "Warren Wilson College", type: "generic", url: "https://www.warren-wilson.edu/about/employment" },
  ...
  { campus: "Louisburg College", type: "generic", url: "https://www.louisburg.edu/employment/index.php" },
  { campus: "Nash Community College", type: "generic", url: "https://www.nashcc.edu/about/employment/" },
  { campus: "Pfeiffer University", type: "generic", url: "https://www.pfeiffer.edu/employment/" },
  { campus: "Salem College", type: "generic", url: "https://www.salem.edu/about/employment/" },
  { campus: "Sampson Community College", type: "generic", url: "https://sampsoncc.edu/about-us/jobs-careers/" },
  { campus: "Montreat College", type: "generic", url: "https://www.montreat.edu/job-openings/" },
  { campus: "Queens University of Charlotte", type: "generic", url: "https://www.queens.edu/careers/why-work-at-queens/career-opportunities-at-queens/" },
  { campus: "Shaw University", type: "generic", url: "https://www.shawu.edu/meet-shaw/career-opportunities/" },
...
const VA_CAMPUSES = [
  ...
  { campus: "Rappahannock Community College", type: "generic", url: "https://www.rappahannock.edu/jobs/" },
  { campus: "Southwest Virginia Community College", type: "generic", url: "http://www.sw.edu/employment.html" },
  { campus: "Tidewater Community College", type: "generic", url: "https://jobs.vccs.edu/postings/search?utf8=%E2%9C%93&query=&query_v0_posted_at_date=&435=&query_organizational_tier_2_id%5B%5D=5402&commit=Search" },
  { campus: "Union Presbyterian Seminary", type: "generic", url: "https://www.upsem.edu/about/employment" },
  ...
  { campus: "Virginia Military Institute", type: "generic", url: "https://www.vmi.edu/job-openings/" },
  { campus: "Radford University", type: "pageup", url: "https://careers.pageuppeople.com/1177/cw/en-us/search/" },
  { campus: "Roanoke College", type: "generic", url: "https://acaweb.roanoke.edu/faculty_jobs" },
  { campus: "Germanna Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7876&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Laurel Ridge Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7880&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Mountain Empire Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7881&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "New River Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7890&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Patrick & Henry Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7892&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Paul D Camp Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7891&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Piedmont Virginia Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7893&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Southside Virginia Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7883&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Virginia Highlands Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7894&query_position_type_id%5B%5D=9&commit=Search" },
  { campus: "Virginia Peninsula Community College", type: "peopleadmin", url: "https://jobs.vccs.edu/postings/search?query_organizational_tier_1_id%5B%5D=7887&query_position_type_id%5B%5D=9&commit=Search" },
...
const SC_CAMPUSES = [
  ...
  { campus: "Sherman College of Chiropractic", type: "generic", url: "https://www.sherman.edu/jobs/" },
  { campus: "Southern Wesleyan University", type: "generic", url: "https://www.swu.edu/about/employment/" },
  { campus: "Spartanburg Community College", type: "generic", url: "https://www.sccsc.edu/about/employment/" },
  { campus: "University of South Carolina Aiken", type: "generic", url: "https://www.usca.edu/employment/" },
...
const DE_CAMPUSES = [
  ...
  { campus: "Goldey-Beacom College", type: "generic", url: "https://www.gbc.edu/career/" },
];
...
const MD_CAMPUSES = [
  ...
  { campus: "Prince George's Community College", type: "generic", url: "https://www.pgcc.edu/careers/" },
  { campus: "Salisbury University", type: "generic", url: "https://www.salisbury.edu/administration/administration-and-finance-offices/human-resources/careers/" },
...
const NY_PRIVATE_CAMPUSES = [
  ...
  { campus: "Hudson Valley Community College", type: "generic", url: "https://www.hvcc.edu/hr/employment-opportunities.html" },
  { campus: "Ithaca College", type: "generic", url: "https://www.ithaca.edu/jobs" },
  ...
  { campus: "Roberts Wesleyan University", type: "generic", url: "https://www.roberts.edu/employment" },
  { campus: "Saint Vladimirs Orthodox Theological Seminary", type: "generic", url: "https://www.svots.edu/about/employment" },
  { campus: "Siena College", type: "generic", url: "https://www.siena.edu/employment-opportunities/" },
  { campus: "St. John's University-New York", type: "generic", url: "https://www.stjohns.edu/law/careers" },
  { campus: "St. Thomas Aquinas College", type: "generic", url: "https://stac.edu/offices/human-resources/employment-opportunities/" },
  { campus: "SUNY Corning Community College", type: "generic", url: "https://www.corning-cc.edu/careers/" },
  { campus: "Tompkins Cortland Community College", type: "generic", url: "https://www.tompkinscortland.edu/hr/employment-opportunities" },
  { campus: "Touro University", type: "generic", url: "https://www.touro.edu/careers/" },
  { campus: "Trocaire College", type: "generic", url: "https://trocaire.edu/about/employment/" },
  ...
  { campus: "Maria College of Albany", type: "generic", url: "https://mariacollege.edu/about-maria/employment" },
  { campus: "Mercy University", type: "generic", url: "https://www.mercy.edu/about/human-resources/employment-mercy" },
  { campus: "Relay Graduate School of Education", type: "generic", url: "https://www.relay.edu/careers" },
  { campus: "Suffolk County Community College", type: "generic", url: "https://www.sunysuffolk.edu/careers/index.jsp" },
  { campus: "SUNY Adirondack", type: "generic", url: "https://www.sunyacc.edu/careers" },
  { campus: "Teachers College at Columbia University", type: "generic", url: "https://employment.tc.columbia.edu/" },
  { campus: "Union College", type: "generic", url: "https://www.union.edu/human-resources/careers" },
  { campus: "Union Theological Seminary in the City of New York", type: "generic", url: "https://utsnyc.edu/about/careers-at-union/" },
  { campus: "Weill Medical College of Cornell University", type: "generic", url: "https://careers.weill.cornell.edu/" },
  { campus: "Helene Fuld College of Nursing", type: "generic", url: "https://www.helenefuld.edu/employment/" },
  { campus: "Paul Smiths College of Arts and Science", type: "generic", url: "https://paulsmith.hrmdirect.com/employment/job-openings.php?search=true" },
  { campus: "University of Mount Saint Vincent", type: "generic", url: "https://mountsaintvincent.edu/campus-life/campus-services/human-resources/" },
...
const WA_CAMPUSES = [
  ...
  { campus: "Pacific Northwest Christian College", type: "generic", url: "https://www.pnwcc.edu/about/employment/" },
  ...
  { campus: "Whatcom Community College", type: "generic", url: "https://www.whatcom.edu/about-wcc/employment-hr/job-information" },
  { campus: "Perry Technical Institute", type: "generic", url: "https://www.perrytech.edu/about/careers/" },
];
...
const ME_CAMPUSES = [
  ...
  { campus: "Kennebec Valley Community College", type: "generic", url: "https://www.kvcc.me.edu/about-kvcc/employment-opportunities/" },
...
const MN_CAMPUSES = [
  ...
  { campus: "Red Lake Nation College", type: "generic", url: "https://www.rlnc.edu/academics/faculty-jobs" },
  { campus: "Saint Mary's University of Minnesota", type: "generic", url: "https://faculty-saintmarysuniversity.icims.com/jobs/search" },
  { campus: "St Cloud Technical and Community College", type: "generic", url: "https://sctcc.edu/employment-opportunities" },
  { campus: "The College of Saint Scholastica", type: "generic", url: "https://www.css.edu/administration/human-resources/employment/" },
  { campus: "University of St Thomas", type: "generic", url: "https://www.stthomas.edu/jobs/" },
  { campus: "University of Northwestern-St Paul", type: "generic", url: "https://www.unwsp.edu/about-us/career-opportunities/" },
  { campus: "Minneapolis Community and Technical College", type: "generic", url: "https://minneapolis.edu/take-action/employment" },
  { campus: "Minnesota North College", type: "generic", url: "https://minnesotanorth.edu/about-us/employment/" },
  { campus: "Mitchell Hamline School of Law", type: "generic", url: "https://mitchellhamline.edu/employment/" },
  { campus: "United Theological Seminary of the Twin Cities", type: "generic", url: "https://www.unitedseminary.edu/employment/" },
  { campus: "Luther Seminary", type: "generic", url: "https://www.luthersem.edu/about/employment/" },
  { campus: "Northwestern Health Sciences University", type: "generic", url: "https://www.nwhealth.edu/careers/" },
  { campus: "Century College", type: "workday", url: "https://minnstate.wd115.myworkdayjobs.com/Minnesota_State_Careers?Institution=a7c1912089511000d545c6af0ef50001" },
  { campus: "Northwest Technical College", type: "workday", url: "https://minnstate.wd115.myworkdayjobs.com/Minnesota_State_Careers?Institution=a7c1912089511000d545de1d40250000" },
...
const ND_CAMPUSES = [
  ...
  { campus: "Lake Region State College", type: "generic", url: "https://www.lrsc.edu/job-opportunities" },
  { campus: "Mayville State University", type: "generic", url: "https://www.mayvillestate.edu/about-msu/employment/" },
  { campus: "Minot State University", type: "generic", url: "https://www.minotstateu.edu/careers/" },
  { campus: "Williston State College", type: "generic", url: "https://willistonstate.edu/about/Employment/" },
  { campus: "United Tribes Technical College", type: "generic", url: "https://uttc.edu/about-uttc/join-our-team/opportunities-positions/" },
];
...
const SD_CAMPUSES = [
  ...
  { campus: "Lake Area Technical College", type: "generic", url: "https://www.lakeareatech.edu/about-latc/careers-at-latc/" },
  { campus: "Southeast Technical College", type: "generic", url: "https://www.southeasttech.edu/employment-hr/index.php" },
  { campus: "Western Dakota Technical College", type: "generic", url: "https://www.wdt.edu/faculty-staff/employment/" },
];
...
const IA_CAMPUSES = [
  ...
  { campus: "Saint Ambrose University", type: "generic", url: "https://sau.edu/about-sau/employment/" },
  { campus: "Southeastern Community College", type: "generic", url: "https://www.scciowa.edu/faculty-employment" },
  { campus: "Southwestern Community College", type: "generic", url: "https://www.swcciowa.edu/human-resources/employment-opportunities" },
  ...
  { campus: "Mount Mercy University", type: "generic", url: "https://www.mtmercy.edu/careers/index" },
  { campus: "William Penn University", type: "generic", url: "https://www.wmpenn.edu/get-to-know-wpu/employment/" },
...
const WY_CAMPUSES = [
  ...
  { campus: "Western Wyoming Community College", type: "generic", url: "https://www.westernwyoming.edu/faculty-employment" },
  { campus: "Laramie County Community College", type: "generic", url: "https://lccc.wy.edu/about/humanResources/index.aspx" },
];
...
const MT_CAMPUSES = [
  ...
  { campus: "Stone Child College", type: "generic", url: "https://www.stonechild.edu/faculty-employment" },
  { campus: "University of Providence", type: "generic", url: "https://www.uprovidence.edu/employment/" },
  { campus: "Salish Kootenai College", type: "generic", url: "https://www.skc.edu/employment/" },
];
...
const WI_CAMPUSES = [
  ...
  { campus: "Ottawa University-Milwaukee", type: "generic", url: "https://www.ottawa.edu/faculty-employment" },
  { campus: "University of Wisconsin-Oshkosh", type: "generic", url: "https://www.uwosh.edu/hr/careers/" },
  { campus: "University of Wisconsin-Stout", type: "generic", url: "https://www.uwstout.edu/employment" },
  { campus: "University of Wisconsin-Superior", type: "generic", url: "https://uwsuper.edu/about/employment/" },
  { campus: "University of Wisconsin-Whitewater", type: "generic", url: "https://www.uww.edu/employment" },
...
const CO_CAMPUSES = [
  ...
  { campus: "Otero College", type: "generic", url: "https://otero.edu/about/careers/" },
  { campus: "Trinidad State College", type: "generic", url: "https://www.trinidadstate.edu/employment/" },
  { campus: "Regis University", type: "generic", url: "https://www.regis.edu/about/offices-services/human-resources/careers" },
  { campus: "Northeastern Junior College", type: "generic", url: "https://www.njc.edu/human-resources/jobs-northeastern" },
  { campus: "Pikes Peak State College", type: "generic", url: "https://www.pikespeak.edu/administration-operations/human-resource-services/employment/index.php" },
  { campus: "Western Colorado University", type: "generic", url: "https://western.edu/about/directory/human-resources/careers-at-western/" },
  { campus: "University of Northern Colorado", type: "csod", url: "https://unco.csod.com/ux/ats/careersite/1/home?c=unco" },
];
...
const OH_CAMPUSES = [
  ...
  { campus: "Kettering College", type: "generic", url: "https://kc.edu/about/employment-opportunities/" },
  ...
  { campus: "Ohio Wesleyan University", type: "generic", url: "https://www.owu.edu/about/offices-services-directory/human-resources/career-information/job-openings/" },
  { campus: "Stark State College", type: "generic", url: "https://www.starkstate.edu/employment-opportunities/" },
  { campus: "Terra State Community College", type: "generic", url: "https://terra.edu/about_us/careers/index.php" },
  { campus: "The College of Wooster", type: "generic", url: "https://wooster.edu/employment" },
  { campus: "United Theological Seminary", type: "generic", url: "https://united.edu/job-opportunities/" },
  { campus: "University of Northwestern Ohio", type: "generic", url: "https://app.unoh.edu/careers/" },
  { campus: "University of Rio Grande", type: "generic", url: "https://www.rio.edu/jobs-opportunities" },
  { campus: "Valor Christian College", type: "generic", url: "https://www.valorcollege.edu/careers" },
  ...
  { campus: "Malone University", type: "generic", url: "https://www.malone.edu/about/offices/employment/" },
  { campus: "North Central State College", type: "generic", url: "https://ncstatecollege.edu/jobs-north-central-state-college-jobs-employment-work/" },
  { campus: "Owens Community College", type: "generic", url: "https://www.owens.edu/about/employment/" },
  { campus: "University of Akron Main Campus", type: "generic", url: "https://www.uakron.edu/hr/jobs.dot" },
  { campus: "Ursuline College", type: "generic", url: "https://www.ursuline.edu/inside-ursuline/employment/overview" },
  { campus: "Lake Erie College", type: "generic", url: "https://www.lec.edu/careers" },
...
const NM_CAMPUSES = [
  ...
  { campus: "San Juan College", type: "generic", url: "https://www.sanjuancollege.edu/careers/" },
...
const NV_CAMPUSES = [
  ...
  { campus: "Touro University Nevada", type: "generic", url: "https://tun.touro.edu/administration/human-resources/careers-with-touro/" },
  { campus: "Western Nevada College", type: "generic", url: "https://wnc.edu/human-resources/jobs.php" },
  { campus: "Nevada System of Higher Education-System Office", type: "generic", url: "https://nshe.nevada.edu/system-administration/departments/human-resources/careers/" },
  { campus: "Wongu University of Oriental Medicine", type: "generic", url: "https://wongu.edu/employment/" },
];
...
const MI_CAMPUSES = [
  ...
  { campus: "Kirtland Community College", type: "generic", url: "https://www.kirtland.edu/human-resources/careers-at-kirtland/faculty-credentialing-review-process/" },
  { campus: "Lansing Community College", type: "generic", url: "https://jobs.lcc.edu/en/listing/" },
  ...
  { campus: "Northwestern Michigan College", type: "generic", url: "https://www.nmc.edu/about/employment/" },
  { campus: "Northwood University", type: "generic", url: "https://www.northwood.edu/jobs/" },
  { campus: "Oakland Community College", type: "generic", url: "https://www.oaklandcc.edu/employment/" },
  { campus: "Spring Arbor University", type: "generic", url: "https://springarbor.edu/about/offices-and-schools/human-resources/careers.php" },
  ...
  { campus: "Kettering University", type: "generic", url: "https://www.kettering.edu/careers" },
...
const IL_CAMPUSES = [
  ...
  { campus: "Illinois College", type: "generic", url: "https://www.ic.edu/employment" },
  { campus: "Illinois Eastern Community Colleges", type: "generic", url: "https://iecc.edu/jobs" },
  { campus: "Judson University", type: "generic", url: "https://www.judsonu.edu/employment/" },
  { campus: "Kaskaskia College", type: "generic", url: "https://www.kaskaskia.edu/hr/employment/" },
  { campus: "Lake Forest College", type: "generic", url: "https://www.lakeforest.edu/careers" },
  ...
  { campus: "Parkland College", type: "generic", url: "https://www.parkland.edu/Main/About-Parkland/Department-Office-Directory/Human-Resources/Employment-Opportunities" },
  { campus: "Rend Lake College", type: "generic", url: "https://rlc.edu/jobs" },
  { campus: "Rock Valley College", type: "generic", url: "https://www.rockvalleycollege.edu/about/employment/index" },
  { campus: "Rosalind Franklin University of Medicine and Science", type: "generic", url: "https://www.rosalindfranklin.edu/employment/" },
  { campus: "School of the Art Institute of Chicago", type: "generic", url: "https://www.saic.edu/faculty-employment" },
  { campus: "South Suburban College", type: "generic", url: "https://www.ssc.edu/careers/faculty" },
  ...
  { campus: "Millikin University", type: "generic", url: "https://millikin.edu/about/university-leadership/human-resources/employment" },
  { campus: "Morrison Institute of Technology", type: "generic", url: "https://www.morrisontech.edu/employment/" },
  { campus: "University of St Francis", type: "peopleadmin", url: "https://stfrancis.peopleadmin.com/postings/search" },
  { campus: "Olivet Nazarene University", type: "generic", url: "https://www.olivet.edu/about/employment/" },
...
const IN_CAMPUSES = [
  ...
  { campus: "Huntington University", type: "generic", url: "https://www.huntington.edu/human-resources/employment-opportunities" },
  { campus: "Indiana University-East", type: "generic", url: "https://east.iu.edu/jobs/" },
  { campus: "Ivy Tech Community College", type: "generic", url: "https://www.ivytech.edu/careers" },
  { campus: "Martin University", type: "generic", url: "https://www.martin.edu/academics/faculty-jobs" },
  { campus: "Purdue University Fort Wayne", type: "generic", url: "https://careers.purdue.edu/FW" },
  { campus: "Purdue University Northwest", type: "generic", url: "https://careers.purdue.edu/PNW" },
  { campus: "Union Bible College", type: "generic", url: "https://www.ubca.org/academics/faculty-jobs" },
  { campus: "University of Evansville", type: "generic", url: "https://www.evansville.edu/offices/hr/employment.cfm" },
  { campus: "University of Saint Francis-Fort Wayne", type: "generic", url: "https://www.sf.edu/about/offices-and-departments/careers/" },
  { campus: "Vincennes University", type: "generic", url: "https://www.vinu.edu/human-resources/employment.html" },
  { campus: "Holy Cross College", type: "generic", url: "https://www.hcc-nd.edu/career-opportunities/" },
  { campus: "Goshen College", type: "generic", url: "https://www.goshen.edu/employment/" },
  { campus: "Hanover College", type: "generic", url: "https://www.hanover.edu/about/employment/" },
  { campus: "Oakland City University", type: "generic", url: "https://www.oak.edu/jobs/" },
  { campus: "Valparaiso University", type: "generic", url: "https://www.valpo.edu/human-resources/" },
];
...
const WV_CAMPUSES = [
  ...
  { campus: "Pierpont Community and Technical College", type: "generic", url: "https://www.pierpont.edu/employment-opportunities/" },
...
const TX_CAMPUSES = [
  ...
  { campus: "LeTourneau University", type: "generic", url: "https://www.letu.edu/offices/administration-finance/hr/employment.html" },
  { campus: "Lone Star College System", type: "generic", url: "https://www.lonestar.edu/employment/" },
  { campus: "McLennan Community College", type: "generic", url: "https://www.mclennan.edu/employment/" },
  ...
  { campus: "St. Mary's University", type: "generic", url: "https://www.stmarytx.edu/about/jobs/" },
  { campus: "Texarkana College", type: "generic", url: "https://www.texarkanacollege.edu/employment/" },
  ...
  { campus: "Texas Tech University Health Sciences Center", type: "generic", url: "https://www.ttuhsc.edu/jobs/" },
  ...
  { campus: "The University of Texas MD Anderson Cancer Center", type: "generic", url: "https://www.mdanderson.org/about-md-anderson/careers.html" },
  { campus: "The University of Texas Rio Grande Valley", type: "generic", url: "https://careers.utrgv.edu/" },
  { campus: "University of Houston-Clear Lake", type: "generic", url: "https://www.uhcl.edu/human-resources/employment/" },
  { campus: "University of Houston-Downtown", type: "generic", url: "https://www.uhd.edu/hr/careers/?ref=short&rid=careers" },
  { campus: "University of Mary Hardin-Baylor", type: "generic", url: "https://www.umhb.edu/resources/careers/home" },
  { campus: "University of the Incarnate Word", type: "generic", url: "https://jobs.uiw.edu/" },
  { campus: "Vernon College", type: "generic", url: "https://www.vernoncollege.edu/faculty-employment" },
  ...
  { campus: "Grace School of Theology", type: "generic", url: "https://gsot.edu/employment/" },
  { campus: "Jarvis Christian University", type: "generic", url: "https://www.jarvis.edu/president/human-resources/" },
  { campus: "Lubbock Christian University", type: "generic", url: "https://lcu.edu/hr" },
  { campus: "Oblate School of Theology", type: "generic", url: "https://www.ost.edu/careers/?category=active" },
  { campus: "Parker University", type: "generic", url: "https://www.parker.edu/human-resources/" },
...
const FL_CAMPUSES = [
  ...
  { campus: "Indian River State College", type: "generic", url: "https://irsc.edu/news/faculty-job-fair-seeks-passionate-educators-join-the-river-community/" },
  { campus: "Jones Technical Institute", type: "generic", url: "https://www.jtech.org/careers-at-jtech/" },
  { campus: "Lynn University", type: "generic", url: "https://www.lynn.edu/employment" },
  { campus: "Palm Beach Atlantic University", type: "generic", url: "https://www.pba.edu/offices/human-resources/employment/" },
  { campus: "Palm Beach State College", type: "generic", url: "https://www.palmbeachstate.edu/employment/" },
  { campus: "Seminole State College of Florida", type: "generic", url: "https://www.seminolestate.edu/jobs" },
  ...
  { campus: "Larkin University", type: "generic", url: "https://www.larkin.edu/human-resources/career-and-employment-opportunities/" },
  { campus: "South Florida State College", type: "generic", url: "https://www.southflorida.edu/college/employment/human-resources-faq" },
  { campus: "Miami Dade College", type: "generic", url: "https://recruitment.mdc.edu/psc/MYMDHPRD/RECRUIT/JOBS/c/HRS_HRAM_FL.HRS_CG_SEARCH_FL.GBL?Action=U&PAGE=HRS_APP_SCHJOB_FL&Page=HRS_APP_SCHJOB_FL" },
  { campus: "Pensacola State College", type: "generic", url: "https://pensacolastate.edu/employment/" },
  { campus: "Trinity Baptist College", type: "generic", url: "https://tcj.edu/about/employment/" },
];
...
const GA_CAMPUSES = [
  ...
  { campus: "Life University", type: "generic", url: "https://www.life.edu/about/employment-opportunities/" },
  { campus: "Piedmont University", type: "generic", url: "https://www.piedmont.edu/employment/" },
  { campus: "South Georgia State College", type: "generic", url: "https://www.sgsc.edu/about/employment" },
  { campus: "Thomas University", type: "generic", url: "https://www.thomasu.edu/about/employment/" },
  { campus: "Truett McConnell University", type: "generic", url: "https://tmu.edu/employment-opportunities/" },
  { campus: "LaGrange College", type: "generic", url: "https://lagrangecollege.applicantstack.com/x/openings" },
  { campus: "Shorter University", type: "generic", url: "https://www.shorter.edu/human-resources/" },
  { campus: "Oglethorpe University", type: "generic", url: "https://oglethorpe.edu/about/offices-departments/human-resources/jobs/" },
...
const AL_CAMPUSES = [
  ...
  { campus: "Samford University", type: "generic", url: "https://www.samford.edu/employee/employment-opportunities" },
  { campus: "Selma University", type: "generic", url: "https://www.selmau.edu/academics/faculty-jobs" },
  { campus: "Snead State Community College", type: "generic", url: "https://snead.edu/about/employment/" },
  { campus: "Talladega College", type: "generic", url: "https://www.talladega.edu/academics/faculty-jobs/" },
...
const AR_CAMPUSES = [
  ...
  { campus: "Ozarka College", type: "generic", url: "https://www.ozarka.edu/faculty-employment" },
  { campus: "South Arkansas College", type: "generic", url: "https://www.southark.edu/academics/faculty-jobs" },
...
const KS_CAMPUSES = [
  ...
  { campus: "Hutchinson Community College", type: "generic", url: "https://www.hutchcc.edu/jobs" },
  { campus: "Kansas Wesleyan University", type: "generic", url: "https://www.kwu.edu/about/careers/" },
  { campus: "MidAmerica Nazarene University", type: "generic", url: "https://www.mnu.edu/employment/" },
  { campus: "Ottawa University-Kansas City", type: "generic", url: "https://www.ottawa.edu/faculty-employment" },
  { campus: "Ottawa University-Online", type: "generic", url: "https://www.ottawa.edu/faculty-employment" },
  { campus: "Ottawa University-Ottawa", type: "generic", url: "https://www.ottawa.edu/faculty-employment" },
  { campus: "Pittsburg State University", type: "generic", url: "https://www.pittstate.edu/hr/jobs.html" },
  { campus: "Saint Paul School of Theology", type: "generic", url: "https://www.spst.edu/jobs/" },
  { campus: "Seward County Community College", type: "generic", url: "https://sccc.edu/employees/hr/employment-opportunities/" },
  { campus: "Sterling College", type: "generic", url: "https://www.sterling.edu/academics/faculty-jobs" },
  { campus: "University of Saint Mary", type: "generic", url: "https://www.stmary.edu/employment" },
  { campus: "Washburn University", type: "generic", url: "https://www.washburn.edu/faculty-staff/human-resources/employment-opportunities/index.html" },
...
const OK_CAMPUSES = [
  ...
  { campus: "Oklahoma City University", type: "generic", url: "https://www.okcu.edu/faculty-staff/human-resources/careers-at-ocu" },
  { campus: "Redlands Community College", type: "generic", url: "https://www.redlandscc.edu/faculty-employment" },
  { campus: "Rogers State University", type: "generic", url: "https://www.rsu.edu/offices-services/human-resources/employment/" },
  { campus: "University of Tulsa", type: "generic", url: "https://utulsa.edu/academics/faculty-jobs" },
  { campus: "Tulsa Community College", type: "generic", url: "https://www.tulsacc.edu/about-tcc/employment" },
...
const MO_CAMPUSES = [
  ...
  { campus: "Rockhurst University", type: "generic", url: "https://www.rockhurst.edu/faculty-employment" },
  { campus: "St Charles Community College", type: "generic", url: "https://stchas.aaimtrack.com/jobs/" },
  { campus: "Three Rivers College", type: "generic", url: "https://trcc.edu/employment-opportunities/" },
  { campus: "University of Central Missouri", type: "generic", url: "https://www.ucmo.edu/offices/human-resources/employment/index.php" },
  { campus: "University of Health Sciences and Pharmacy in St. Louis", type: "generic", url: "https://www.uhsp.edu/why-uhsp/employment-opportunities/" },
  { campus: "William Woods University", type: "generic", url: "https://www.williamwoods.edu/employment/" },
...
const KY_CAMPUSES = [
  ...
  { campus: "Kentucky Wesleyan College", type: "generic", url: "https://kwc.edu/about-wesleyan/employment-opportunities/" },
  { campus: "Lindsey Wilson College", type: "generic", url: "https://www.lindsey.edu/about-lwc/Offices-and-Services/Human-Resources/job-opportunities.cfm" },
  { campus: "Louisville Presbyterian Theological Seminary", type: "generic", url: "https://www.lpts.edu/employment/" },
  { campus: "Transylvania University", type: "generic", url: "https://www.transy.edu/employment-opportunities/" },
  { campus: "University of Louisville", type: "generic", url: "https://louisville.edu/careers" },
  { campus: "Lexington Theological Seminary", type: "generic", url: "https://lextheo.edu/about-the-seminary/employment-opportunities/" },
  { campus: "Hazard Community and Technical College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/hazard-jobs" },
  { campus: "Henderson Community College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/henderson-jobs" },
  { campus: "Jefferson Community and Technical College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/jefferson-jobs" },
  { campus: "Madisonville Community College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/madisonville-jobs" },
  { campus: "Maysville Community and Technical College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/maysville-jobs" },
  { campus: "Owensboro Community and Technical College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/owensboro-jobs" },
  { campus: "Somerset Community College", type: "pageup", url: "https://careers.kctcs.edu/jobs/search/somerset-jobs" },
...
const TN_CAMPUSES = [
  ...
  { campus: "Southern Adventist University", type: "generic", url: "https://www.southern.edu/administration/hr/foremployees/openings.html" },
  { campus: "Tennessee State University", type: "generic", url: "https://www.tnstate.edu/careers/" },
  { campus: "Tennessee Wesleyan University", type: "generic", url: "https://www.tnwesleyan.edu/about/departments/human-resources/faculty-openings/" },
  { campus: "The University of Tennessee Southern", type: "generic", url: "https://utsouthern.edu/about/employment-opportunities/" },
  { campus: "Volunteer State Community College", type: "generic", url: "https://www.volstate.edu/employment" },
  { campus: "Walters State Community College", type: "generic", url: "https://ws.edu/faculty-employment" },
  { campus: "Welch College", type: "generic", url: "https://welch.edu/academics/academic-offices/office-of-the-provost/job-opportunities/" },
  { campus: "Roane State Community College", type: "generic", url: "https://www.roanestate.edu/?5581-Current-Job-Listings-at-Roane-State" },
  { campus: "Milligan University", type: "generic", url: "https://milligan.edu/employment/" },
...
const AK_CAMPUSES = [
  ...
  { campus: "University of Alaska System of Higher Education", type: "generic", url: "https://careers.alaska.edu/" },
];
...
for (const campuses of [
  ...
  NC_CAMPUSES, VA_CAMPUSES, SC_CAMPUSES, DE_CAMPUSES, MD_CAMPUSES, DC_CAMPUSES, RI_CAMPUSES, RI_PRIVATE_CAMPUSES,
...
export async function scrapeAllJobsStandalone() {
  ...
  try {
    ...
    let tasks = [
      ...
      { name: "DC", fn: () => scrapeDcAll(context) },
...
async function scrapeDcAll(context) {
  const results = await mapWithConcurrency(
    DC_CAMPUSES,
    MAX_PARALLEL_CAMPUSES,
    async ({ campus, type, url }) => {
  ...
  try {
    ...
    const evalResult = await safeEvaluate(page, () => {
      ...
      for (const a of Array.from(document.querySelectorAll("a[href]"))) {
        ...
        // WordPress archive/author links can sit inside the same post card as
        // its real title. The CTA fallback then borrows that title while
        // retaining the archive URL, yielding several copies of one posting
        // (observed on United Tribes Technical College's faculty board).
        // These routes are indexes or author biographies, never job details.
        if (/\/(?:author|category|tag)\//i.test(url)) continue;
        ...
        // Navigation menus sometimes prefix this same standing resource hub
        // with a bullet/dash and "Student &" (for example, Oblate School of
        // Theology renders "- Student & Faculty Resources"). It is still page
        // chrome, not a faculty vacancy. Keep the match anchored so a real role
        // such as "Faculty Resources Coordinator" is not discarded.
        if (/^[\s\-–—•]*(?:student\s*&\s*)?faculty\s+resources?(\s+center)?$/i.test(title)) continue;
