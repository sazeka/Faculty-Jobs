...
## Unspecified-role audit (September 24, 2026 snapshot)

The 22,828-listing snapshot initially had 5,817 listings in “Faculty, role unspecified.” An audit of frequent titles and explicit role terms found 3,662 titles with an Adjunct appointment status; “Adjunct Faculty” is a common example. Adjunct describes appointment status and does not establish whether the specific role is Professor, Lecturer, or Instructor. The stored `positionType` field was also inconsistent for broad faculty titles, so it was not used to assign a more specific role.

Titles explicitly saying “Professorial Faculty” did support the Professor role. Adding that narrow rule moved 13 listings out of the unspecified group in this snapshot, leaving 5,804. The panel now reports the Adjunct overlap directly. Remaining broad faculty titles retain the unspecified label until a reviewed source supports a more specific role. This audit is a classification review, not a new population-wide accuracy estimate.
