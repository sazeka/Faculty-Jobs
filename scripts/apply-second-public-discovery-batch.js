...
const validation = read("generated/second-public-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the second public-institution discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/second-public-discovery-batch-milestone.json", {
