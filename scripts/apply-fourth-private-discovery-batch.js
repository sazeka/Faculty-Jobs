...
const validation = read("generated/fourth-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the fourth private-nonprofit discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/fourth-private-discovery-batch-milestone.json", {
...
console.log(`Applied ${validation.promotedCount} sources; ${master.counts.covered - coveredBefore} newly covered; ${validation.heldCount} held.`);
