...
const validation = read("generated/seventh-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the seventh private-nonprofit discovery batch on 2026-08-28. ${control.evidence}`;
  ...
  Object.assign(institution, {
    ...
    coverage_status: "covered", verification_status: "healthy", last_verified_at: validation.generatedAt,
    last_seen_job_count: 0, last_discovery_status: "official_scoped_source_validated",
    last_discovery_confidence: 1, last_discovery_attempt_at: validation.generatedAt, notes
  });
}
...
write("generated/seventh-private-discovery-batch-milestone.json", {
  generatedAt: validation.generatedAt, scope: validation.scope, reviewedCount: validation.reviewedCount,
  ...
  missingAfter: master.counts.missing, safeguards: validation.safeguards
});
console.log(`Applied ${validation.promotedCount} sources; ${validation.heldCount} held.`);
