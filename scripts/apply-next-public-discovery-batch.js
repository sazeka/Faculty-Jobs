...
const validation = read("generated/next-public-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the next public-institution discovery batch on 2026-08-27. ${control.evidence}`;
  const replacement = {
    name: control.name,
...
write("generated/next-public-discovery-batch-milestone.json", {
