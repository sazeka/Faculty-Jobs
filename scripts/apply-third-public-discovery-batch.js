...
const validation = read("generated/third-public-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the third public-institution discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/third-public-discovery-batch-milestone.json", {
