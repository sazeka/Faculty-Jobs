...
const validation = read("generated/eighth-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the eighth private-nonprofit discovery batch on 2026-08-28. ${control.evidence}`;
...
write("generated/eighth-private-discovery-batch-milestone.json", {
