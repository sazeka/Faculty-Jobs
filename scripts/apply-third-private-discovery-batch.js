...
const validation = read("generated/third-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the third private-nonprofit discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/third-private-discovery-batch-milestone.json", {
