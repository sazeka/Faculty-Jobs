...
const validation = read("generated/first-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the first private-nonprofit discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/first-private-discovery-batch-milestone.json", {
