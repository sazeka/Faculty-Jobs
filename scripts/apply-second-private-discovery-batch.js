...
const validation = read("generated/second-private-discovery-batch-validation.json");
...
for (const control of validation.promoted) {
  const notes = `Verified in the second private-nonprofit discovery batch on 2026-08-27. ${control.evidence}`;
...
write("generated/second-private-discovery-batch-milestone.json", {
